...
router.post('/atacar', autenticar, validar(bossSchema.atacar), bossController.atacar);
router.post('/:guildaId/recompensas', autenticar, bossController.distribuirRecompensas);
