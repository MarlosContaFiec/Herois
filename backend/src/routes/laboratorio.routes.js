...
router.delete('/:id', autenticar, validar(labSchema.remover), labController.remover);
router.post('/:id/transferir', autenticar, validar(labSchema.transferir), labController.transferir);
