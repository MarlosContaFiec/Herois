export const btnBase = "inline-flex items-center justify-center gap-2 px-4 py-2 rounded-lg text-sm font-medium cursor-pointer transition-all duration-200 whitespace-nowrap disabled:opacity-50 disabled:cursor-not-allowed";
...
export const inputBase = "w-full px-3 py-2.5 bg-slate-800 border border-slate-700 rounded-lg text-slate-100 placeholder-slate-500 focus:outline-none focus:border-cyan-500 focus:ring-1 focus:ring-cyan-500/30 transition-colors duration-200";
export const selectBase = "w-full px-3 py-2.5 bg-slate-800 border border-slate-700 rounded-lg text-slate-100 focus:outline-none focus:border-cyan-500 focus:ring-1 focus:ring-cyan-500/30 transition-colors duration-200 cursor-pointer";
export const labelBase = "block text-sm font-medium text-slate-300 mb-1.5";
export const cardBase = "bg-slate-900 border border-slate-700/60 rounded-xl overflow-hidden";
export const cardHover = "hover:border-cyan-500/40 hover:shadow-xl hover:shadow-cyan-500/5 hover:-translate-y-1 transition-all duration-300";
...
export const raridadeCores = {
  COMUM: { bg: 'bg-slate-500/20', text: 'text-slate-400', border: 'border-slate-500/40', badge: 'bg-slate-500/20 text-slate-400 border border-slate-500/30', gradiente: 'from-slate-600/20 to-transparent' },
  INCOMUM: { bg: 'bg-emerald-500/20', text: 'text-emerald-400', border: 'border-emerald-500/40', badge: 'bg-emerald-500/20 text-emerald-400 border border-emerald-500/30', gradiente: 'from-emerald-600/20 to-transparent' },
  RARA: { bg: 'bg-cyan-500/20', text: 'text-cyan-400', border: 'border-cyan-500/40', badge: 'bg-cyan-500/20 text-cyan-400 border border-cyan-500/30', gradiente: 'from-cyan-600/20 to-transparent' },
  EPICA: { bg: 'bg-purple-500/20', text: 'text-purple-400', border: 'border-purple-500/40', badge: 'bg-purple-500/20 text-purple-400 border border-purple-500/30', gradiente: 'from-purple-600/20 to-transparent' },
  LENDARIA: { bg: 'bg-amber-500/20', text: 'text-amber-400', border: 'border-amber-500/40', badge: 'bg-amber-500/20 text-amber-400 border border-amber-500/30', gradiente: 'from-amber-600/20 to-transparent' },
  UNICA: { bg: 'bg-pink-500/20', text: 'text-pink-400', border: 'border-pink-500/40', badge: 'bg-pink-500/20 text-pink-400 border border-pink-500/30', gradiente: 'from-pink-600/20 to-transparent' },
};
export const elementoCores = {
  FOGO: { text: 'text-red-400', bg: 'bg-red-500/20', badge: 'bg-red-500/20 text-red-400 border border-red-500/30' },
  AGUA: { text: 'text-blue-400', bg: 'bg-blue-500/20', badge: 'bg-blue-500/20 text-blue-400 border border-blue-500/30' },
  TERRA: { text: 'text-amber-500', bg: 'bg-amber-500/20', badge: 'bg-amber-500/20 text-amber-400 border border-amber-500/30' },
  VENTO: { text: 'text-emerald-400', bg: 'bg-emerald-500/20', badge: 'bg-emerald-500/20 text-emerald-400 border border-emerald-500/30' },
  LUZ: { text: 'text-yellow-300', bg: 'bg-yellow-300/20', badge: 'bg-yellow-300/20 text-yellow-300 border border-yellow-300/30' },
  TREVAS: { text: 'text-purple-400', bg: 'bg-purple-600/20', badge: 'bg-purple-600/20 text-purple-400 border border-purple-600/30' },
};
export const navLink = "flex items-center gap-2 px-3 py-2 rounded-lg text-sm text-slate-400 hover:text-slate-100 hover:bg-slate-800 transition-all duration-200";
export const navLinkActive = "flex items-center gap-2 px-3 py-2 rounded-lg text-sm text-cyan-400 bg-cyan-500/10 border border-cyan-500/20";
...
export const progressTrack = "w-full h-2 bg-slate-800 rounded-full overflow-hidden";
export const progressBar = "h-full bg-gradient-to-r from-cyan-500 to-cyan-400 rounded-full transition-all duration-500";
export const progressBarAmber = "h-full bg-gradient-to-r from-amber-500 to-amber-400 rounded-full transition-all duration-500";
export const toastBase = "flex items-center gap-3 px-4 py-3 rounded-xl shadow-2xl border backdrop-blur-sm min-w-[300px]";
